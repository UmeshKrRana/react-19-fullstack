    ...
    <div className="flex justify-center">
      <div className="bg-white shadow rounded p-6 w-full max-w-xl">
        ...
        <form className="space-y-6" onSubmit={handleSubmit(submitForm)}>
          ...
          <div>
            <input
              {...register("fullName", {
                ...
                minLength: {
                  value: 5,
                  message: "Full name must be atleast 5 chars long",
                },
              })}
              type="text"
          ...
          {/* Submit button */}
          <div className="pt-4 flex gap-4 items-center justify-between">
            <button
              className="px-3 bg-blue-600 text-white py-1.5 rounded hover:bg-blue-700 transition cursor-pointer"
              type="submit"
            >
              {isEdit ? "Update" : "Create"} User
            </button>
